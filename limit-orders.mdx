...
Buy limit orders are placed from the [**Market screen**](https://docs.merlin.trade/trading/events-and-markets).
...
Posted orders appear in your [**Limit Orders**](https://docs.merlin.trade/trading/limit-orders#viewing-limit-orders)**** list and will fill when the market reaches your price.
